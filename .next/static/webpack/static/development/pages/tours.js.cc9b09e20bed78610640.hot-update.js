...
})(["display:block;width:100%;max-width:25rem;padding:12px;border-radius:", " / 2;font-size:", ";font-weight:bold;&.submit,&.primary{background:", ";color:", ";}&:disabled{cursor:not-allowed;}&.disabled{color:", ";background:", ";}"], function (props) {
...
})(["display:block;width:100%;max-width:25rem;padding:12px;border-radius:calc(", " / 2);font-size:", ";font-weight:bold;&.submit,&.primary{background:", ";color:", ";}&:disabled{cursor:not-allowed;}&.disabled{color:", ";background:", ";}"], function (props) {
  return props.theme.border_radius;
}, function (props) {
  return props.theme.xs;
}, function (props) {
...
//# sourceMappingURL=tours.js.cc9b09e20bed78610640.hot-update.js.map