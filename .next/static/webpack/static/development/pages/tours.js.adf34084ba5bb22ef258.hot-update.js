...
})(["width:100%;padding:12px;border-radius:", " / 2;font-size:", ";font-weight:bold;&.submit,&.primary{background:", ";color:", ";}&:disabled{cursor:not-allowed;}&.disabled{color:", ";background:$c-disabled-bg;}"], function (props) {
...
})(["width:100%;padding:12px;border-radius:", " / 2;font-size:$f-xs;font-weight:bold;&.submit,&.primary{background:$c-blue;color:$c-white;}&:disabled{cursor:not-allowed;}&.disabled{color:$c-disabled-txt;background:$c-disabled-bg;}"], function (props) {
  return props.theme.border_radius;
});
...
//# sourceMappingURL=tours.js.adf34084ba5bb22ef258.hot-update.js.map