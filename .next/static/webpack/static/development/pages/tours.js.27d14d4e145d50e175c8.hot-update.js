...
})(["width:100%;padding:12px;border-radius:", " / 2;font-size:", ";font-weight:bold;&.submit,&.primary{background:$c-blue;color:$c-white;}&:disabled{cursor:not-allowed;}&.disabled{color:$c-disabled-txt;background:$c-disabled-bg;}"], function (props) {
  return props.theme.border_radius;
}, function (props) {
  return props.theme.xs;
});
...
//# sourceMappingURL=tours.js.27d14d4e145d50e175c8.hot-update.js.map