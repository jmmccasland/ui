...
})(["display:block;width:100%;max-width:25rem;margin:0 auto;padding:12px;border-radius:", " / 2;font-size:", ";font-weight:bold;&.submit,&.primary{background:", ";color:", ";}&:disabled{cursor:not-allowed;}&.disabled{color:", ";background:", ";}"], function (props) {
...
})(["display:block;width:100%;max-width:25rem;margin:0 auto;padding:12px;border-radius:calc(", " / 2);font-size:", ";font-weight:bold;&.submit,&.primary{background:", ";color:", ";}&:disabled{cursor:not-allowed;}&.disabled{color:", ";background:", ";}"], function (props) {
  return props.theme.border_radius;
}, function (props) {
  return props.theme.xs;
}, function (props) {
...
//# sourceMappingURL=tours.js.6c819a6386fc2ef909a6.hot-update.js.map