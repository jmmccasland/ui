...
})(["width:100%;padding:12px;border-radius:", " / 2;font-size:", ";font-weight:bold;&.submit,&.primary{background:$c-blue;color:", ";}&:disabled{cursor:not-allowed;}&.disabled{color:", ";background:$c-disabled-bg;}"], function (props) {
  return props.theme.border_radius;
}, function (props) {
  return props.theme.xs;
}, function (props) {
...
//# sourceMappingURL=tours.js.de395a0a5504e5523ec3.hot-update.js.map